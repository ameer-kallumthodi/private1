...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'SAIDALI' : process.env.OWNER_NAME,
    OWNERNUM: process.env.OWNER_NUMBER === undefined ? '918606759500' : process.env.OWNER_NUMBER,
    ANTILINK: process.env.ANTI_LINK === undefined ? 'false' : process.env.ANTI_LINK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'http://imgur.com/gallery/c1q2yDE.jpg' : process.env.ALIVE_LOGO,
