...
WhatsAlexa.addCommand({pattern: 'dis ?(.*)', fromMe: true, desc: DDO,dontAddCMDList: true }, (async (message, match) => {    
...
WhatsAlexa.addCommand({pattern: 'adis ?(.*)', fromMe: true, desc: DDO,dontAddCMDList: true }, (async (message, match) => {   
